...
|   `3` | `LAST_WRITIER_WIN_NO_CAS_RMW`                 | Yes, CAS loop or fetch-op                | For counters, cursors, epochs, clocks, version increments, occupancy deltas. No `CLAIMED` state needed.   |
...
| cursor                                   | `LAST_WRITIER_WIN_NO_CAS_RMW`                                                              | Yes loop or fetch-add |
| counter                                  | `LAST_WRITIER_WIN_NO_CAS_RMW`                                                              | Yes loop or fetch-add |
| epoch                                    | `LAST_WRITIER_WIN_NO_CAS_RMW`                                                              | Yes                   |
...
| `MODEL48::SUBDIVISION16x3_INTERNAL_CELL_MODEL`          | packed occupancy/counters    | atomic snapshot for read                                           | `LAST_WRITIER_WIN_NO_CAS_RMW` CAS loop                                              |
| `MODEL48::FOUR_SUBDIVISION_2x16_AND_2x8`                | packed multi-field model     | atomic snapshot/versioned validation                               | usually `CLAIMED_GUARDED` or `LAST_WRITIER_WIN_NO_CAS_RMW` depending on mutation    |
...
| ---------- | ----------------------- | ----------------------------------------------------- |
| `VALUE32`  | `GenericAccessContract` | only if subclass is `CLAIMED_GUARDED` or `LAST_WRITIER_WIN_NO_CAS_RMW`    |
| `VALUE48`  | `GenericAccessContract` | only if subclass is `CLAIMED_GUARDED` or `LAST_WRITIER_WIN_NO_CAS_RMW`    |
...
VALUE32 + LAST_WRITIER_WIN_NO_CAS_RMW       = CAS loop/fetch operation
...
VALUE48 + LAST_WRITIER_WIN_NO_CAS_RMW       = CAS loop/fetch operation
```
...
| queue cursors                  | `VALUE48 + LAST_WRITIER_WIN_NO_CAS_RMW`                                            |
| fabric counters                | `VALUE48 + LAST_WRITIER_WIN_NO_CAS_RMW`                                            |
...
| occupancy approximation        | `MODEL32` pair or `MODEL48` packed model, `LAST_WRITIER_WIN_NO_CAS_RMW` on update  |
